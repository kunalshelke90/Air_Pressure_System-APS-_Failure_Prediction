...
class ModelTrainerConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.excpected_accuracy:float=training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
...
class ModelEvaluationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_evalution_dir:str=os.path.join(training_pipeline_config.artifact_dir,training_pipeline.MODEL_EVALUATION_DIR_NAME)
        
        self.report_file_path=os.path.join(self.model_evalution_dir,training_pipeline.MODEL_EVALUATION_REPORT_NAME)
