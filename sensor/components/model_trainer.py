...
class ModelTrainer:
    ...
    def perform_hyper_parameter_tuning(self):
        pass  # Implement hyperparameter tuning if needed
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            if classification_train_metric.f1_score <= self.model_trainer_config.excpected_accuracy:
                raise Exception("Trained model does not meet expected accuracy")
